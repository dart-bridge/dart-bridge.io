...
library templates_2015_10_03_15_21_46_915;
...
<div class="choke">
  <ul class="menu-master alpha">
    ...
    <ul class="menu-master gamma">
      ${await (() async => (area == 'docs') ? """
        ${(await Future.wait((docRoutes.keys).map((category) async => """
          <ul class="menu-master category">
            <span>$category</span>
            ${(await Future.wait((docRoutes[category]).map((route) async => """
              <li><a href="${route.url}">${route.title}</a></li>
            """))).join("")}</ul>
        """))).join("")}""" : (area == 'resources') ? """
        <li><a href="/docs">Some page</a></li>
        <li><a href="/docs">Some page</a></li>
        <li><a href="/docs">Some page</a></li>
        <li><a href="/docs">Some page</a></li>
        <li><a href="/docs">Some page</a></li>
...
""", data: data),
    "resources": () async => new Template(parsed: """${await $extends('app', {'content': """
  ...
  <article class="choke">
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi aperiam assumenda cum cupiditate dignissimos earum est ex exercitationem magnam minima nam non nulla, pariatur, quidem sit tempore unde, veniam voluptas?
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi aperiam assumenda cum cupiditate dignissimos earum est ex exercitationem magnam minima nam non nulla, pariatur, quidem sit tempore unde, veniam voluptas?
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi aperiam assumenda cum cupiditate dignissimos earum est ex exercitationem magnam minima nam non nulla, pariatur, quidem sit tempore unde, veniam voluptas?
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi aperiam assumenda cum cupiditate dignissimos earum est ex exercitationem magnam minima nam non nulla, pariatur, quidem sit tempore unde, veniam voluptas?
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi aperiam assumenda cum cupiditate dignissimos earum est ex exercitationem magnam minima nam non nulla, pariatur, quidem sit tempore unde, veniam voluptas?
